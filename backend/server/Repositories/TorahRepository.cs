...
namespace server.Repositories
{
    public class TorahRepository
    {
        ...
        public string GenerateDrasha(DrashaFilters filters) 
        {
            ...
            ChatClient client = new(model: "gpt-5-mini", apiKey);
            ChatCompletion completion = client.CompleteChat($@"
            You are a knowledgeable Jewish rabbi and Torah scholar, well-versed in classical sources such as the Torah, Midrash, Talmud, and traditional commentators.
